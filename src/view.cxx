...
View::View(Model const& model)
        ...
        , crosshair_posn_{(int) ((model_.get_model_dims().width /
                                  2) - (crosshair_dims_.width / 2)),
                          (int) (
                                  (model_
                                           .get_model_dims()
                                           .height / 2) - (crosshair_dims_.height
                                                           / 2))}
{ }
...
{
    // draws crossshair. z-value: 10 TODO: probably gonna want to change this
